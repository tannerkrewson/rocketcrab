...
- **Questioning**: the game leader (person who started the game) begins by questioning another player about the location. _Example: ("is this a place where children are welcome?")._
...
- **Indictment**: group successfully indicts a player after voting _OR_
- **Spy guesses**: spy stops the round to make a guess about the location _OR_
